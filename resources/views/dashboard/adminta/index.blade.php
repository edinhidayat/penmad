...
@section('konten')
    <div class="row">
        <div class="col-lg-8 mt-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-0"><b>Tahun Ajaran</b></h5>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/admin/ta/create" class="btn btn-primary mb-2"><i class="fas fa-plus"></i> Tambah Data</a>
                            ...
                            @foreach ($ta as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/ta/{{ $item->id }}/edit" style="text-decoration: none;"
