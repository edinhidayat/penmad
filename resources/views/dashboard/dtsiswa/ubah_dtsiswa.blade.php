    ...
    <div class="col-8">
      <div class="card card-info mt-3">
        <div class="card-header">
          <h3 class="card-title"><b>Ubah Data Siswa</b></h3>
        </div>
        <div class="card-body">
          <!-- Input Data Siswa -->
          <form action="/dashboard/dtsiswa/{{ $datasiswa->id }}" method="post">
            @method('put')
            @csrf
            <div class="row">
              <div class="col-3">
                <div class="form-group">
                  <input type="hidden" name="madrasah_id" id="madrasah_id" value={{ $datasiswa->madrasah_id }}>
                  ...
                  <select class="form-control @error('tahunajaran_id') is-invalid @enderror" name="tahunajaran_id"
                    ...
                    @foreach ($tahunajaran as $item)
                      @if (old('tahunajaran_id', $datasiswa->tahunajaran_id) == $item->id)
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('lakilaki') is-invalid @enderror" name="lakilaki"
                    id="lakilaki" value="{{ old('lakilaki', $datasiswa->lakilaki) }}"
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('perempuan') is-invalid @enderror" name="perempuan"
                    id="perempuan" value="{{ old('perempuan', $datasiswa->perempuan) }}"
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('total') is-invalid @enderror" name="total"
                    id="total" value="{{ old('total', $datasiswa->total) }}" readonly>
                  @error('total')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('kip') is-invalid @enderror" name="kip"
                    id="kip" value="{{ old('kip', $datasiswa->kip) }}" onkeypress="return hanyaAngka(event)"
                    required>
                  @error('kip')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('kks') is-invalid @enderror" name="kks"
                    id="kks" value="{{ old('kks', $datasiswa->kks) }}" onkeypress="return hanyaAngka(event)"
                    required>
                  @error('kks')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="col-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('pkh') is-invalid @enderror" name="pkh"
                    id="pkh" value="{{ old('pkh', $datasiswa->pkh) }}" onkeypress="return hanyaAngka(event)"
                    required>
                  @error('pkh')
                    <div class="invalid-feedback">
                      {{ $message }}
