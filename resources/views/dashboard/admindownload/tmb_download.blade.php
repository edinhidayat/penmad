...
<div class="row">
    <div class="col-lg d-flex justify-content-center">
        <div class="card" style="width: 80%;">
            <div class="card-body">
            <!-- Input Data Siswa -->
            <form action="/admin/download" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="judul">Keterangan</label>
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul"
                        id="judul" value="{{ old('judul') }}" required autofocus>
                    @error('judul')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="col-5 form-control @error('petugas') is-invalid @enderror" name="petugas"
                        id="petugas" value="{{ old('petugas') }}" required>
                    @error('petugas')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
