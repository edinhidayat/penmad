        ...
        <div class="col-5">
            <div class="card card-info mt-3">
                <div class="card-header">
                    <h3 class="card-title"><b>Tambah Kategori Laporan</b></h3>
                </div>
                <div class="card-body">
                    <!-- Input Kategori Laporan -->
                    <form action="/admin/katlap" method="post">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control @error('jenislaporan') is-invalid @enderror"
                                    name="jenislaporan" id="jenislaporan" value="{{ old('jenislaporan') }}" autofocus
                                    required>
                            </div>
                            @error('jenislaporan')
