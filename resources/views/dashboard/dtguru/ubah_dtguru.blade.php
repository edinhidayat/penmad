    ...
    <div class="col-10">
      <div class="card card-info mt-3">
        <div class="card-header">
          <h3 class="card-title"><b>Ubah Data Guru</b></h3>
        </div>
        <div class="card-body">
          <!-- Input Data Guru -->
          <form action="/dashboard/dtguru/{{ $dataguru->id }}" method="post">
            @method('put')
            @csrf
            <div class="form-group">
              <input type="hidden" name="madrasah_id" id="madrasah_id" value={{ $dataguru->madrasah_id }}>
              <label>Nama Guru</label>
              <input type="text" class="form-control @error('namaguru') is-invalid @enderror" name="namaguru"
                id="namaguru" value="{{ old('namaguru', $dataguru->namaguru) }}" autofocus required>
              @error('namaguru')
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('gelardepan') is-invalid @enderror" name="gelardepan"
                    id="gelardepan" value="{{ old('gelardepan', $dataguru->gelardepan) }}">
                  @error('gelardepan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('gelarbelakang') is-invalid @enderror"
                    name="gelarbelakang" id="gelarbelakang" value="{{ old('gelarbelakang', $dataguru->gelarbelakang) }}">
                  @error('gelarbelakang')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip"
                    id="nip" value="{{ old('nip', $dataguru->nip) }}" required>
                  @error('nip')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <select class="form-control @error('Jeniskelamin') is-invalid @enderror" name="jeniskelamin"
                    id="jeniskelamin" style="width: 100%;" required>
                    @foreach ($jeniskelamin as $item)
                      @if (old('jeniskelamin', $dataguru->jeniskelamin) == $item->kelamin)
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control @error('tempatlahir') is-invalid @enderror" name="tempatlahir"
                    id="tempatlahir" value="{{ old('tempatlahir', $dataguru->tempatlahir) }}" required>
                  @error('tempatlahir')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <input type="date" class="form-control @error('tanggallahir') is-invalid @enderror"
                    name="tanggallahir" id="tanggallahir" value="{{ old('tanggallahir', $dataguru->tanggallahir) }}"
                    required>
                  @error('tanggallahir')
                    <div class="invalid-feedback">
                      {{ $message }}
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <select class="form-control @error('gol') is-invalid @enderror" name="gol" id="gol"
                    ...
                    @foreach ($gol as $item)
                      @if (old('gol', $dataguru->gol) == $item->gol)
                ...
                <div class="col-9">
                  ...
                  <input type="text" class="form-control @error('pangkat') is-invalid @enderror" name="pangkat"
                    id="pangkat" value="{{ old('pangkat', $dataguru->pangkat) }}" readonly>
                  @error('pangkat')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('mapel') is-invalid @enderror" name="mapel"
                id="mapel" value="{{ old('mapel', $dataguru->mapel) }}" required>
              @error('mapel')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('lulusan') is-invalid @enderror" name="lulusan"
                    id="lulusan" value="{{ old('lulusan', $dataguru->lulusan) }}" required>
                  @error('lulusan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-7">
                  ...
                  <input type="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan"
                    id="jurusan" value="{{ old('jurusan', $dataguru->jurusan) }}" required>
                  @error('jurusan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-2">
                  ...
                  <input type="text" class="form-control @error('tahunlulus') is-invalid @enderror"
                    name="tahunlulus" id="tahunlulus" value="{{ old('tahunlulus', $dataguru->tahunlulus) }}" required>
                  @error('tahunlulus')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
